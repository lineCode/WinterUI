...
struct Pixmap
{
	...
	/// Pixmap from data
	WINTERGUI_API inline Pixmap(unsigned char &&**pixmap, size_t width, size_t height, bool hasAlpha = false, bool srgb = false)
	{
	...
	WINTERGUI_API inline Pixmap(unsigned char red, unsigned char green, unsigned char blue, unsigned char alpha, bool srgb = false)
	{
		this->width = 1;
		this->height = 1;
		this->srgb = srgb;
